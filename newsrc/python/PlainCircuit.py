...
res_real = torch.argmax(output_real).item()

# Emotion Classification    
if res == 0:
    print("Plain-Precomputed: sadness")
elif res == 1:
    print("Plain-Precomputed: joy")
elif res == 2:
    print("Plain-Precomputed: love")
elif res == 3:
    print("Plain-Precomputed: anger")
elif res == 4:
    print("Plain-Precomputed: fear")
elif res == 5:
    print("Plain-Precomputed: suprise")
...
if res_real == 0:
    print("Plain-PyTorch    : sadness")
elif res_real == 1:
    print("Plain-PyTorch    : joy")
elif res_real == 2:
    print("Plain-PyTorch    : love")
elif res_real == 3:
    print("Plain-PyTorch    : anger")
elif res_real == 4:
    print("Plain-PyTorch    : fear")
elif res_real == 5:
    print("Plain-PyTorch    : suprise")
